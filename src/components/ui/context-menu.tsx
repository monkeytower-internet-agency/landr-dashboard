// landr-oxlk — shadcn-style ContextMenu primitive. Mirrors the
// dropdown-menu.tsx wrapper exactly: every Radix part is re-exported
// behind a thin function that injects a data-slot and the project's
// tailwind class soup so consumers stay shadcn-shaped. Right-click on a
// row → BookingRowContextMenu / ContactRowContextMenu wraps the table
// cells with these primitives.
