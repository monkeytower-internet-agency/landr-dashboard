              ...
              {!data?.connected && (
                <Button
                  ...
                  onClick={() => {
                    ...
                    // window.open return null, which fell through to a full-tab
                    // redirect (the dashboard tab got eaten + a blank tab opened). We
                    // need the handle to navigate the popup in onSuccess.
